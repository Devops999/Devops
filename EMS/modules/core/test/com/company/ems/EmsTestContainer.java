...
public class EmsTestContainer extends TestContainer {

    public EmsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ems/app.properties",
    ...
    public static class Common extends EmsTestContainer {

        public static final EmsTestContainer.Common INSTANCE = new EmsTestContainer.Common();
