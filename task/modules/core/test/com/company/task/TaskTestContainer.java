...
public class TaskTestContainer extends TestContainer {

    public TaskTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/task/app.properties",
    ...
    public static class Common extends TaskTestContainer {

        public static final TaskTestContainer.Common INSTANCE = new TaskTestContainer.Common();
