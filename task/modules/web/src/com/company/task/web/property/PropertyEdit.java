package com.company.task.web.property;

import com.haulmont.cuba.core.app.FileStorageService;
import com.haulmont.cuba.core.entity.FileDescriptor;
import com.haulmont.cuba.core.global.FileStorageException;
import com.haulmont.cuba.gui.components.AbstractEditor;
import com.company.task.entity.Property;
...
public class PropertyEdit extends AbstractEditor<Property> {
    private Logger log = LoggerFactory.getLogger(PropertyEdit.class);
    ...
    @Inject
    private Datasource<Property> propertyDs;
    ...
    public void init(Map<String, Object> params) {
        ...
        propertyDs.addItemPropertyChangeListener(event -> {
