...
public class AccordionTestContainer extends TestContainer {

    public AccordionTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/accordion/app.properties",
    ...
    public static class Common extends AccordionTestContainer {

        public static final AccordionTestContainer.Common INSTANCE = new AccordionTestContainer.Common();
