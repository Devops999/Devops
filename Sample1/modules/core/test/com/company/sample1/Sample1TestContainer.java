...
public class Sample1TestContainer extends TestContainer {

    public Sample1TestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/sample1/app.properties",
    ...
    public static class Common extends Sample1TestContainer {

        public static final Sample1TestContainer.Common INSTANCE = new Sample1TestContainer.Common();
