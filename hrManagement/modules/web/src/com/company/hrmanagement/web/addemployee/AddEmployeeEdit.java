package com.company.hrmanagement.web.addemployee;

import com.haulmont.cuba.core.app.FileStorageService;
import com.haulmont.cuba.core.entity.FileDescriptor;
import com.haulmont.cuba.core.global.FileStorageException;
import com.haulmont.cuba.gui.components.AbstractEditor;
import com.company.hrmanagement.entity.AddEmployee;
...
public class AddEmployeeEdit extends AbstractEditor<AddEmployee> {

        private Logger log = LoggerFactory.getLogger(AddEmployeeEdit.class);
        ...
        @Inject
        private Datasource<AddEmployee> addEmployeeDs;
        ...
        public void init(Map<String, Object> params) {
            ...
            addEmployeeDs.addItemPropertyChangeListener(event -> {
